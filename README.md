...
* Clone it locally.
* Create a new branch.
* Add your logo image to `/assets/img/logos/` directory. The logo should be at least 150px of height. Name your logo with your company/project name.
